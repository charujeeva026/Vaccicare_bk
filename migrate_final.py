...
def migrate():
    try:
        ...
        # Set datestyle for both connections to handle DD-MM-YYYY
        new_cur.execute("SET datestyle = 'DMY'")
        old_cur.execute("SET datestyle = 'DMY'")
        ...
        print("Ordered migration with fixed date format finished!")
